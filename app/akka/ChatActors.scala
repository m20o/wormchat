...
class Supervisor() extends Actor {
  ...
  context.system.scheduler.schedule(1 seconds, 800 millis, juliet, ChatActors.Talk)
  
  val romeo = context.actorOf(Props(new Chatter("Romeo", Quotes.romeo)))
  context.system.scheduler.schedule(5 seconds, 800 millis, romeo, ChatActors.Talk)
